...
typedef struct Proto
{
    ...
    PROTO_LOCVARS_ENC<struct LocVar*> locvars; // 0x28
    ...
    PROTO_DEBUGNAME_ENC<TString*> debugname; // 0x78
    GCObject* gclist; // 0x80
    int sizelineinfo; // 0x88
    int sizep; // 0x8C
    int sizeupvalues; // 0x90
...
#define luaO_nilobject reinterpret_cast<TValue*>(Offsets::LuaO_NilObject)
